                                ...
                                aboutContents.map((content, _) => (
                                    <div className={"about-row row"} data-aos={"fade-up"}>
                                        <div className={"about-icon-container col-xs-12 col-sm-12 col-md-2 col-lg-2"}>
                                            <img src={`${process.env.PUBLIC_URL}/icons/${content.name.toLowerCase()}.svg`} alt={content.name} className={"about-icon"} />
                                        </div>
                    ...
                    {(() => {
                        ...
                        return (
                            valueContents.map((content, _) => (
                                <div className={"value-container value-col col-xs-12 col-sm-12 col-md-3 col-lg-3"} data-aos={"fade-up"}>
                                    <div className={"value-icon-container"}>
                                        <img src={`${process.env.PUBLIC_URL}/icons/${content.name.toLowerCase()}.svg`} alt={content.name} />
                                    </div>
                ...
                <div className={"row"}>
                    ...
                    <div className={"col-xs-12 col-sm-12 col-md-4 col-log-4"}>
                        <Quote author={"Andrew Kim"} position={"President, Class of '25"}>
                            Woodson Scioly is so much more than studying and taking tests. We ate, traveled, watched the World Cup, and played basketball last season as well. I hope future members will enjoy it as much as I did last season.
                        </Quote>
